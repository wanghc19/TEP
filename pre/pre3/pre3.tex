...
\begin{frame}{Accuracy and Sign Convention}
  ...
  \begin{tabular}{rrrrr}
    ...
    Table & \(kd\) & \(\beta d\) & \(|G_{\mathrm{MFS}}-G_{\mathrm{Ewald}}|\)
      & relative error\\
    \hline
    2 & \(2\) & \(\sqrt2\) & \(1.3868{\times}10^{-8}\) & \(2.3985{\times}10^{-8}\)\\
    3 & \(10\) & \(5\sqrt2\) & \(1.4511{\times}10^{-8}\) & \(3.6683{\times}10^{-8}\)\\
    4 & \(2\) & \(3\) & \(2.4016{\times}10^{-8}\) & \(3.1527{\times}10^{-8}\)\\
    \hline
  \end{tabular}
  \end{center}
...
\begin{frame}{Representative Values}
  ...
  \begin{tabular}{rll}
    ...
    \(0.4595298689+0.3509130960\ii\)\\
    3 &
    \(0.3538172307+0.1769332383\ii\) &
    \(0.3538172165+0.1769332413\ii\)\\
    4 &
    \(0.7617463954+0.0006387129\ii\) &
    \(0.7617464190+0.0006387086\ii\)\\
    \hline
  \end{tabular}
  \end{center}
  ...
  \begin{block}{Interpretation}
    With the default benchmark MFS parameters, the single-point table
    errors are about \(10^{-8}\).  This is enough to reproduce the Linton
    values to roughly 7--8 significant digits after the sign conversion.
  \end{block}
\end{frame}

\begin{frame}{Runtime Comparison}
  \scriptsize
  Timing is from the same run as the accuracy table.  The MFS time includes
  proxy/Rayleigh precomputation and evaluation.  Importantly,
  \[
    \texttt{kernel.qpgreen\_mfs}
  ...
  \begin{tabular}{rrrrrr}
    ...
    \hline
    2 & \(0.007459\) & \(0.579123\) & \(0.573020\) & \(0.005108\) & \(77.6\)\\
    3 & \(0.001190\) & \(0.486196\) & \(0.485263\) & \(0.000749\) & \(408.6\)\\
    4 & \(0.000635\) & \(0.513697\) & \(0.512857\) & \(0.000657\) & \(808.8\)\\
    \hline
  \end{tabular}
  \end{center}
