...
新框架已经冻结 $A_{\mathrm{def}}^{D/G}$ 的 block roles，并通过两项独立 design review。
下一步只授权 test-local static assembly oracle；production half-guide、导数和 locator 仍未
授权。恢复 production I4 前至少需要关闭以下 formulation blockers。
\begin{enumerate}
...
全部 production 门关闭以后，I4 才能按“构造一个由式\eqref{eq:continuous-pencil} 派生的
balanced matrix evaluator，再做 bounded locator 和 analytic-disk readiness”的顺序恢复。
