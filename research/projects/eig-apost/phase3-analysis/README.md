...
`PASS WITH CONDITIONS`。本目录只能优先推进 C4--C5 的
...
- [[research/projects/eig-apost/phase3-analysis/s-root|Root qualification]]：区分实轴奇异值
  极小点与实际 NEP root，并冻结结构保持的远端闭合。
- [[research/projects/eig-apost/phase3-analysis/s-errors|Error budget]]：误差来源、冻结/变化
  参数和隔离测试。
- [[research/projects/eig-apost/phase3-analysis/s-estimator|Candidate estimator]]：主
  estimator、辅助 diagnostics、effectivity 和接受标准。
