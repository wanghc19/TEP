...
%KGREEN Evaluate branch-anchored QP Green pair matrices.
%
% Purpose:
...
%
% Numerical goal:
%   Ensure off-box Green evaluation uses the common I1.4 branch provider.
...
function periodic_axis = LOCAL_parse_periodic_axis(pars1, varargin)
  ...
  if ~strcmp(periodic_axis, 'x') && ~strcmp(periodic_axis, 'y')
    error('kready:InvalidPeriodicAxis', ...
