function out = cfg()
%CFG Return the frozen I1.4 complex-wavenumber readiness pilot settings.
% Purpose:
%   Keep the I1.3 parent, two pilot nodes, analytic representation, and
%   fail-closed thresholds explicit without changing package or parent code.
% Output:
%   out - Complete immutable settings for run_pilot and eval_k.

  out.schema = 'TEP_I1_K_READY_PILOT_V1';
  out.experiment_id = 'I1-K-READY-PILOT-V1';
  ...
  % The homogeneous missing-column cell and both spatial levels are copied
  % exactly from the frozen I1.3 configuration.
  out.beta = 0.5;
  out.d = 1.0;
  out.R = 0.2;
  out.s = 1.0;
  ...
  % Frozen analytic representation.
  ...
  % Bounded pilot engineering gates and later full-run estimate geometry.
