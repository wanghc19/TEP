...
- Status: `MANUFACTURED_PASS_REAL_NOT_RUN_PREREQ`
- K: `3`
...
| real | cell_input_provenance | CELL_INPUT_PROVENANCE_FAIL | 0 |
| real | real_qz | NOT_RUN_PREREQ | 0 |
| real | real_halfguide_graph | NOT_RUN_PREREQ | 0 |
| real | real_dtn | NOT_RUN_PREREQ | 0 |
| real | real_adef | NOT_RUN_PREREQ | 0 |

Preflight status is `CELL_INPUT_PROVENANCE_FAIL`; later real gates retain their recorded statuses above.
