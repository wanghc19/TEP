...
% LOCAL_PRECOMP_PROXY_INSTRUMENTED Return the frozen proxy system and output.
%
% Purpose:
%   Expose the existing A, b, and coeffs locals from the frozen
%   kernel.precomp_proxy implementation for a test-only provenance audit.
%
% Input:
...
%
% Output:
%   proxy  - Public proxy struct q, Z, H, C_up, and C_down.
%   A      - Copied overdetermined collocation matrix.
%   b      - Copied collocation right-hand side.
%   coeffs - Coefficients produced by the copied minimum-norm branch.
%
% Based on:
%   +kernel/precomp_proxy.m at frozen full-file SHA-256
%   3a16825064e5762f3486373fee702e94c34fa3cfdfb3b774f78f3b27eb2f9a60.
%
% Main changes:
%   Only the function declaration and this help text differ. The block from
%   the stage-1 marker through proxy.C_down is copied byte-for-byte.
%
% Numerical goal:
%   Supply one source-derived A,b pair to every test-local comparison solver
%   without modifying or claiming direct access to the package internals.
